...
(4, 2025) => Ok(Box::new(year_2025::day_04::Day::new())),
(5, 2025) => Ok(Box::new(year_2025::day_05::Day::new())),
(1, 2025) => Ok(Box::new(year_2025::day_01::Day::new())),
(8, 2025) => Ok(Box::new(year_2025::day_08::Day::new())),
